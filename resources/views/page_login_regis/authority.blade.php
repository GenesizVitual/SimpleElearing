...
<html lang="en">
<head>
	<title>Mts Ummusshabri Authority</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="{{ url('login-authority') }}" method="post" class="login100-form validate-form">
					{{ csrf_field() }}
					<span class="login100-form-title p-b-43">
						Silahkan masuk authority.
					</span>
					...
					@endif
					<div class="wrap-input100 validate-input" data-validate = "Valid Kode is required: xyz">
